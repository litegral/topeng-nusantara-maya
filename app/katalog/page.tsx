                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        {filteredTopeng.map((topeng, index) => (
                            ...
                            >
                                ...
                                {/* Overlay */}
                                <div className="absolute inset-0 bg-gradient-to-t from-brown/90 via-brown/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
